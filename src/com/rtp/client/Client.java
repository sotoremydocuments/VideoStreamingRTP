...
public class Client{
    ...
    static int RTP_RCV_PORT = 25002; //port where the client will receive the RTP packets
    ...
    static int RTCP_RCV_PORT = 19003;   //port where the client will receive the RTP packets
